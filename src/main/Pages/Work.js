...
const OneStuffsContainer = ({ title, parentCallback, description, Images, gotALink, theLink }) => {
    useEffect(() => {
        let stuff = document.querySelector(`#${title}`)
        stuff.style.backgroundImage = `url(${Images[0]})`
    })
    return (
        <div onClick={() => parentCallback(title, description, Images, gotALink, theLink)} className="stuffs_contain">
    ...
    return (
        <div id='Work' className='.all'>
            ...
            <div className="web_work ">
                <OneStuffsContainer parentCallback={clickOnWork} title="Geek-Blog" gotALink={true}
...
ps: le code est en open-source sur mon Github`} theLink={'https://geek--blog.herokuapp.com/SignUp'} Images={["https://previews.dropbox.com/p/thumb/ABM5-sgid-GwgpImXkyytq_mQ3Kfjbre3S4zGkDi7neQcijfDMQDFLeoQvrQY4eDggqEns9gEbMM1H5ooRGi1ym11BcCVBWHVD9SASpPar5pW57KRqmr3Lwm3GjQmSqc4mEqNx8AHZedT9AG_sBjzH_jZJK1bswl4vFJR8JKdrl91zpcCmaV0d3_aEZbJaH5h5UPTF6_8V84zQ0rI5_19QKWgJwRakeFHI9Rz6RjRXLnQNMqkxN4_gpKXIlQS5H7loYMFAlZa3bF02ZNb8AL-c2I2ymcpMuv20ApDWG9h9mGELCFMXb5TpyW34LSumjX-lOfosIZD3RRdTRnSvdyAgNK6idbc1Bfz9aCmPal53eEuQ/p.png?fv_content=true&size_mode=5",
                ...
                <OneStuffsContainer parentCallback={clickOnWork} title="ffff2" gotALink={false} description='aaaa' theLink={'test'} Images={[
                ...
                <OneStuffsContainer parentCallback={clickOnWork} title="ffff3" gotALink={false} description='aaaa' theLink={'test'} Images={[
                ...
                <OneStuffsContainer parentCallback={clickOnWork} title="ffff4" gotALink={false} description='aaaa' theLink={'test'} Images={[]} />
                <OneStuffsContainer parentCallback={clickOnWork} title="ffff5" gotALink={false} description='aaaa' theLink={'test'} Images={[]} />
                <OneStuffsContainer parentCallback={clickOnWork} title="ffff6" gotALink={false} description='aaaa' theLink={'test'} Images={[]} />
